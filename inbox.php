											...
											<div class="main-content-left main-content-left-mail">
												<div class="main-mail-menu">
													<nav class="nav main-nav-column mg-b-20">
														...
														<a class="nav-link" href="sentbox.php">
										...
										<div class="table-responsive">
											<table class="table table-inbox text-md-nowrap table-hover text-nowrap">
												<tbody>
													<?php
															// Inbox for Admin
													   $select_box = "SELECT * FROM tbl_inbox";
													   $run_box    = mysqli_query($db, $select_box);
					                                   ...
					                                   else
					                                   {
														   while($row_box    = mysqli_fetch_array($run_box))
														 	{
															   $message_id    = $row_box['message_id'];
															   $sender_name   = $row_box['sender_name'];
															   $sender_email  = $row_box['sender_email'];
															   $subject       = $row_box['subject'];
															   $message       = $row_box['message'];
															   $mail_date     = $row_box['mail_date'];
														
													?>

													<tr class="">
														<td class="inbox-small-cells">
															 <a style="background: red; border: 1px solid red" class="btn ripple btn-info" data-target="#delete<?php echo $message_id;?>" data-toggle="modal" href="#delete<?php echo $message_id;?>"> <i class="fa fa-trash fa-danger"></i>
	                                                        </a>
														</td>
														<td class="view-message view-message">
														<a href="read-message.php?mail_id=<?php echo $message_id; ?>">
															<?php echo $subject; ?>
														</a>
														</td>
													 ...
													 <!-- Delete Modal -->
								<div class="modal" id="delete<?php echo $message_id;?>">
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content modal-content-demo">
											<div class="modal-header">
												<h6 class="modal-title">Delete Inbox Details</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
											</div>
											<div class="modal-body">
												<form action="inbox-del.php" method="post">
													 <input type="hidden" class="form-control" name="message_id" value="<?php echo $message_id; ?>" required> 
						...
						<div class="main-mail-compose-box">
							...
							<div class="main-mail-compose-body">
								...
								<div class="form-group mb-0">
									...
									<div>
										<input class="form-control" name="mail_to" placeholder="Recipient Email" type="text">
									</div>
								</div>
...
<?php
  ...
  if(isset($_POST['btn-send']))
  {
      ...
      // For All Members
      $insert_mail = "INSERT INTO tbl_mailbox(sender_name, receiver_name, subject, message, mail_date)VALUES('$mail_from','$mail_to', 
      '$subject', '$message', NOW())";
      $run_mail  	 = mysqli_query($db, $insert_mail);

      // For Admin Only
      $mail_admin = "INSERT INTO tbl_admin_mail(sender_name, receiver_name, subject, message, mail_date)VALUES('$mail_from', 
      '$mail_to', '$subject', '$message', NOW())";
