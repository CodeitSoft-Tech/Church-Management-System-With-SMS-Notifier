				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Draft</h2>
								<ol class="breadcrumb">
						...
						<div class="row row-sm">
												...
												<div class="main-mail-menu">
													<nav class="nav main-nav-column mg-b-20">
														...
														<a class="nav-link" href="sentbox.php">
															<i class="fe fe-send"></i> Sent <span><?php echo $count_sent; ?></span>
														</a>
														<a class="nav-link active" href="draft.php">
							...
							<div class="col-xl-9 col-lg-8  main-content-body-mail1">
								<div class="card custom-card mail-container task-container overflow-hidden">
												...
												<tbody>
													...
													<tr class="">
														<td class="inbox-small-cells">
															 <a style="background: red; border: 1px solid red" class="btn ripple btn-info" data-target="#delete<?php echo $draft_id;?>" data-toggle="modal" href="#delete<?php echo $draft_id;?>"> <i class="fa fa-trash fa-danger"></i>
	                                                        </a>
														</td>
														<td class="view-message view-message">
														<a href="read-draft-message.php?mail_id=<?php echo $draft_id; ?>">
															<?php echo $subject; ?>
														</a>
														</td>
								 ...
								 <!-- Delete Modal -->
								<div class="modal" id="delete<?php echo $draft_id;?>">
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content modal-content-demo">
											<div class="modal-header">
												<h6 class="modal-title">Delete Draft Details</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
											</div>
											<div class="modal-body">
												<form action="draft-del.php" method="post">
