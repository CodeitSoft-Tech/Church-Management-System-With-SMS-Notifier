...
<?php   
  ...
  if(isset($_GET['mail_id']))
  {
      ...
      $select_msg = "SELECT * FROM tbl_draft WHERE draft_id = '$mail_id'";
				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">View Draft</h2>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Inbox</a></li>
									<li class="breadcrumb-item active" aria-current="page">View Draft</li>
								</ol>
							</div>
						</div>
						<!-- End Page Header -->
											...
											<div class="main-mail-menu pd-r-0 mg-t-20">
												<nav class="nav main-nav-column mg-b-20">
													...
													<a class="nav-link" href="sentbox.php">
														<i class="fe fe-send"></i> Sent <span>
															<?php echo $count_sent; ?>
														</span>
													</a>
											...
											<div class="media mt-0">
												<div class="media-body tx-inverse">
													...
													<div class="media-title font-weight-semiblod"><span class="tx-18 font-weight-bold">Sender: <?php echo $sender_name; ?></span>
													    ...
													    <?php echo date("M d, Y h:i a",strtotime($mail_date));?>
														</small>
													</div>
												</div>
											</div>
