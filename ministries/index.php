...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Hillemunah | Ministry Panel </title>
					...
					<div class="main-header-right">
						...
						<div class="dropdown main-profile-menu">
							<?php 
								  ...
								  $username = $_SESSION['minUsername'];
								 $select_pro = "SELECT * FROM ministry_tbl WHERE username = '$username'";
					              $run_pro = mysqli_query($db, $select_pro);
					              $row_pro = mysqli_fetch_array($run_pro);
					              $ministry_img     = $row_pro['ministry_photo'];
					              $ministry_name    = $row_pro['ministry_name'];
					              $ministry_id      = $row_pro['ministry_id'];
			                      $ministry_email   = $row_pro['ministry_email'];
			                      $ministry_number  = $row_pro['ministry_number'];
			                      $ministry_date    = $row_pro['ministry_date'];
			                      $ministry_prez    = $row_pro['ministry_prez'];
			                      $ministry_veep    = $row_pro['ministry_veep'];

							?>
							<a class="d-flex" href="">
							<span class="main-img-user" ><img alt="avatar" src="../church-images/ministries/<?php echo $ministry_img; ?>"></span>
							</a>
							<div class="dropdown-menu">
								<div class="header-navheading">
									<h6 class="main-notification-title"><?php echo $ministry_name; ?></h6>
									<p class="main-notification-text"><span class="badge badge-success"> Ministry </span></p>
								</div>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
						...
						<div class="dropdown main-profile-menu">
							...
							<div class="dropdown-menu">
								<div class="header-navheading">
									<h6 class="main-notification-title"><?php echo $ministry_name; ?></h6>
									<p class="main-notification-text">Ministry</p>
								</div>
								<a class="dropdown-item" href="logout.php">
									<i class="fe fe-power"></i> Logout
								</a>
							...
							<div class="col-xl-3 col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-header">
										<h3 class="main-content-label">Ministry Account</h3>
									</div>
									<div class="card-body text-center item-user">
										<div class="profile-pic">
											<div class="profile-pic-img">
												<span class="bg-success dots" data-toggle="tooltip" data-placement="top" title="online"></span>
												<img src="church-images/ministries/<?php echo $ministry_img; ?>" class="rounded-circle" alt="user">
											</div>
											<a href="#" class="text-dark">
												<h5 class="mt-3 mb-0 font-weight-semibold"><?php echo $ministry_name; ?></h5>
											</a>
										</div>
									</div>
									<ul class="item1-links nav nav-tabs  mb-0">
										...
										<li class="nav-item">
											<a data-target="#profile" class="nav-link active" data-toggle="tab" role="tablist"><i class="ti-user icon1"></i> Ministry Profile </a>
										</li>
										...
										<li class="nav-item">
											<a data-target="#members" class="nav-link" data-toggle="tab" role="tablist"><i class="si si-people icon1"></i> Ministry Members </a>
										</li>
										...
										<div class="tab-content" id="myTabContent">
											...
											<div class="tab-pane fade show active" id="profile" role="tabpanel">
												<div class="d-flex mb-4">
													<label class="main-content-label my-auto"> Ministry Profile </label>
												</div>			
													<div class="row">
													<div class="col-lg-12 col-xl-6">
														<div class="card custom-card border mb-lg-0">
															<div class="card-header pb-3">
															<h6 class="mb-0"><i class="ti-user mr-2"></i>Ministry Details</h6>
															</div>
															<div class="card-body">
																<p><?php echo $ministry_name; ?></p>
																<p><?php echo $ministry_email; ?></p>
																<p class="mb-0"><?php echo $ministry_number; ?></p>
															    <hr>
																<p><b>Date Instituted: </b> <?php echo date("M d, Y",strtotime($ministry_date)); ?></p>
															</div>
															<div class="card-footer">
																<div class="row">
																	<div class="col-6">
																	<a href="#update<?php echo $ministry_id;?>" data-target="#update<?php echo $ministry_id; ?>" data-toggle="modal" style="color:#fff;" class="btn btn-block btn-primary mb-1">
					...
					<div class="modal-content modal-content-demo">
						...
						<div class="">
							<div class="form-group col-md-9">
								...
								<input type="hidden" class="form-control" name="ministry_id" value="<?php echo $ministry_id; ?>"><input type="text" value="<?php echo $ministry_name; ?>" name="ministry_name" class="form-control" required="" >
							</div>

							<div class="form-group col-md-9">
								<label style="font-size: 16.5px; font-weight: 700;"> Email </label>
								<div class="pos-relative">
								<input type="hidden" class="form-control" name="ministry_id" value="<?php echo $ministry_id; ?>"><input type="text" name="ministry_email" value="<?php echo $ministry_email; ?>" class="form-control" required="" >
								</div>
							</div>
							...
							<div class="form-group col-md-9">
								...
								<input type="text" name="ministry_number" value="<?php echo $ministry_number; ?>" class="form-control" required="">
								</div>
							</div>
							...
							<div class="form-group col-md-9">
								<label style="font-size: 16.5px; font-weight: 700;"> Ministry President's Name  </label>
								<div class="pos-relative">
								<input type="hidden" class="form-control" name="ministry_id" value="<?php echo $ministry_id; ?>">
								<input type="text" name="ministry_prez" value="<?php echo $ministry_prez; ?>" class="form-control" required="" >
								</div>
							</div>

							<div class="form-group col-md-9">
								<label style="font-size: 16.5px; font-weight: 700;"> Ministry Vice President's Name  </label>
								<div class="pos-relative">
								<input type="hidden" class="form-control" name="ministry_id" value="<?php echo $ministry_id; ?>">
								<input type="text" name="ministry_veep" value="<?php echo $ministry_veep; ?>" class="form-control" required="" >
								</div>
							</div>
							...
							<div class="form-group col-md-9">
								...
								<div class="pos-relative">
								<input type="hidden" class="form-control" name="ministry_id" value="<?php echo $ministry_id; ?>">
								<input type="file" class="form-control" name="ministry_img">
								<img src="church-images/ministries/<?php echo $ministry_img; ?>" alt="<?php echo $ministry_name; ?>" width="100" height="100">
								</div>
							</div>
							...
							<!--End Large Modal -->
													...
													<div class="col-lg-12 col-xl-6">
														<div class="card custom-card border mb-0">
															<div class="card-header pb-3">
																<h6 class="mb-0"><i class="ti-home mr-2"></i>Ministry Leaders</h6>
															</div>
															<div class="card-body">
																<p><b>President:</b> <?php echo $ministry_prez; ?> </p>
																<p class="mb-0"><b>Vice President:</b> <?php echo $ministry_veep; ?></p>
															</div>
											...
											<div class="tab-pane fade" id="donate" role="tabpanel">
												<div class="d-flex mb-4">
													<label class="main-content-label my-auto"> Ministry Donations </label>
												</div>
												...
												<div class="table-responsive">
								                    ...
								                    $get_min = "SELECT * FROM ministry_tbl WHERE username = '$username'";
								                    $run_min = mysqli_query($db, $get_min);
								                    $row_min = mysqli_fetch_array($run_min);
								                    $ministry_name = $row_min['ministry_name'];

								                    $i = 0;
								                    $sql = "SELECT * FROM donation_tbl WHERE name = '$ministry_name'";
									   ...
									   <div class="modal" id="Donate">
										<div class="modal-dialog modal-lg" role="document">
											<div class="modal-content modal-content-demo">
												...
												<div class="">
													...
													<div class="form-group col-md-9">
														...
														<input type="text" name="fullname" value="<?php echo $ministry_name; ?>" class="form-control" required>
													</div>
													...
													<div class="form-group col-md-9">
														<div class="row row-sm">	
														 <div class="col-sm-6">
													    <label style="font-size: 16.5px; font-weight: 700;">Phone Number</label>
														<input type="text" name="phone_number" value="<?php echo $ministry_number; ?>" class="form-control" required="" >
														</div>
											...
											<div class="tab-pane fade" id="pledge" role="tabpanel">
												<div class="d-flex mb-4">
													<label class="main-content-label my-auto"> Ministry Pledges </label>
												</div>
												<div class="mb-4 pull-right">
												...
												<div class="table-responsive">
								                    ...
								                    $i = 0;
								                    $sql = "SELECT * FROM pledges_tbl WHERE member_name = '$ministry_name'";
								                    $query = mysqli_query($db, $sql) or die(mysqli_error($db));
								                    if(mysqli_num_rows($query) == 0)
								                    {
									   ...
									   <div class="modal" id="Pledge">
										<div class="modal-dialog modal-lg" role="document">
											<div class="modal-content modal-content-demo">
												...
												<div class="">
													<div class="form-group col-md-9">
														<label style="font-size: 16.5px; font-weight: 700;">
														 Member Name</label>
														<input type="text" name="member_name" value="<?php echo $ministry_name; ?>"  class="form-control" required>
													</div>
											...
											<div class="tab-pane fade" id="eventrequest" role="tabpanel">
												...
												<div class="">
													...
													<div class="form-group col-md-9">
														<div class="row row-sm">
															...
															<div class="col-sm-6 mg-t-20 mg-sm-t-0">
																...
																<input type="text" value="<?php echo $ministry_name; ?>" name="organized_by" class="form-control" required="" >
															</div>
													...
													<div class="form-group col-md-9">
														<label style="font-size: 16.5px; font-weight: 700;">Event Descritpion</label>
														<div class="pos-relative">
			                            ...
			                            <td>
			                              ...
			                              ?>
												...
												<label class="main-content-label my-auto">Ministry's Event Request Status</label>
												</div>
													...
													<table class="table border text-nowrap">
							                          ...
							                          $sql = "SELECT * FROM events_tbl WHERE organized_by = '$ministry_name'";
							                          $query = mysqli_query($db, $sql) or die(mysqli_error($db));
			                            ...
			                            <td>
			                              ...
			                              ?>
											...
											<div class="tab-pane fade" id="servicerequest" role="tabpanel">
												...
												<div class="">
													...
													<div class="form-group col-md-9">
														<label style="font-size: 16.5px; font-weight: 700;">
														 Service By</label>
														<input type="text" name="service_by" value="<?php echo $ministry_name; ?>" class="form-control" required="" >
													</div>
											...
											<div class="tab-pane fade" id="service" role="tabpanel">
					                          ...
					                          ?>
												...
												<div class="table-responsive">
													...
													<label class="main-content-label my-auto">Ministry's Service Request Status</label>
												</div>
													<table class="table border text-nowrap">
														<thead>
															<tr>
												...
												$i = 0;
					                            $sql = "SELECT * FROM service_tbl WHERE service_by = '$ministry_name'";
					                            $query = mysqli_query($db, $sql) or die(mysqli_error($db));
											...
											<div class="tab-pane fade" id="members" role="tabpanel">
												<div class="d-flex mb-4">
													<label class="main-content-label my-auto"> Ministry Members </label>
												</div>			
													<div class="row">
													<div class="col-lg-12">
														<div class="card custom-card border mb-0">
												...
												$i = 0;
					                            $sql = "SELECT * FROM members_tbl WHERE ministry_id = '$ministry_id'";
					                            $query = mysqli_query($db, $sql) or die(mysqli_error($db));
											...
											<div class="tab-pane fade" id="dues" role="tabpanel">
												<div class="d-flex mb-4">
													<label class="main-content-label my-auto"> Ministry Dues </label>
												</div>		
												<div class="row">
													...
													<div class="col-lg-12 mb-4">
														<div class="card custom-card border mb-lg-0">
															...
															<div class="">
																...
																<div class="form-group col-md-9">
																<input type="hidden" value="<?php echo $ministry_name; ?>" name="ministry_name" class="form-control" required>
																</div>
											...
											<table id="example1" class="table table-striped table-bordered text-nowrap" >
												...
												$username = $_SESSION['minUsername'];
								                 ...
								                 $i = 0;
								                 $get_dues = "SELECT * FROM ministries_dues WHERE ministry_name = '$ministry_name'";
								                 $run_dues = mysqli_query($db, $get_dues);
								                 while($row_dues = mysqli_fetch_array($run_dues))
								                 {

								                 	$dues_id 		= $row_dues['dues_id'];
			...
			<!--End Delete Modal -->
										 ...
										 <div class="tab-pane fade" id="msgchurch" role="tabpanel">
										 	<?php
										 	   ...
										 	   $select_mail = "SELECT * FROM tbl_mailbox WHERE receiver_name = '$ministry_name'";
											   $run_mail    = mysqli_query($db, $select_mail);
											   $count_inbox  = mysqli_num_rows($run_mail);

											   $select_mail = "SELECT * FROM tbl_members_draft WHERE sender_name = '$ministry_name'";
											   $run_mail    = mysqli_query($db, $select_mail);
											   $count_draft = mysqli_num_rows($run_mail);

											   $select_mail = "SELECT * FROM tbl_members_sentbox WHERE sender_name = '$ministry_name'";
											   $run_mail    = mysqli_query($db, $select_mail);
                              ...
                              <div class="tab-content" id="custom-tabs-three-tabContent">
                                ...
                                <div class="card-body">
                                  <div class="form-group">
                                    <input class="form-control" value="<?php echo $ministry_name; ?>" name="fullname" required>
                                  </div>
                              ...
                              <div class="table-responsive mailbox-messages">
                                ...
                                ?>
                                  ...
                                  <td class="mailbox-subject">
                                  	<a style="text-decoration: none;" href="read-inbox-mail.php?mailbox_id=<?php echo $mailbox_id; ?>"><b><?php echo $subject; ?></b></a> 
                                  </td>
										...
										<!-- Member Form -->
											...
											<div class="col-md-12 col-lg-12 col-xl-12">
												<?php  
													    ...
													    $username = $_SESSION['minUsername'];
								                 		$select_min = "SELECT * FROM ministry_tbl WHERE username = '$username'";
												...
												<form action="ministry-account.php" method="post" enctype="multipart/form-data">

												<div class="">
													<div class="form-group col-md-9">
														<label style="font-size: 16.5px; font-weight: 700;">
														Username</label>
														<input type="hidden" name="min_id" value="<?php echo $min_id; ?>" class="form-control">
