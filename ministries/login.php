    ...
    <div class="forms">
        <div class="form-content">
          <div class="login-form">
            <div class="title">Ministry Panel</div>
          <form action="login.php" method="post">
            ...
            <div class="input-boxes">
              ...
              <div class="input-box">
                ...
                <input type="text" placeholder="Username" name="min_name">
              </div>
              
              <div class="input-box">
                <i class="fas fa-lock"></i>
                <input type="password" placeholder="Password" name="min_pass">
              </div>

              <div class="button input-box">
                <input type="submit" name="ministry_login" value="Login">
              </div>
